...
| [V4.2B](SPRINT_V4_2B_SPAN_CONTROLLED_ATLAS_CORRECTIVE_CLOSEOUT.md) | active — final closeout gate | Implementation, closeout tests, CI, and docs are in tree; canonical generation, independent review, and V4-229 authorization reset remain (V4-220–V4-229). [Final gate](V4_2B_FINAL_CLOSEOUT_GATE.md). [Cursor guide](V4_2B_FINAL_CLOSEOUT_CURSOR_GUIDE.md). |
