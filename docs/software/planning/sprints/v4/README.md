...
**Status:** Sprint V4.1 is **completed**. Sprint V4.2 and V4.2A are **completed historical diagnostics**. Sprint V4.2B is **completed**. Sprint V4.2C is **drafted / blocked** until `ACTIVE_SPRINT.md` names V4-230–V4-239. Sprint V4.3 remains **drafted / blocked**. Authorization is only the range named in `ACTIVE_SPRINT.md`.
...
| [V4.2C](SPRINT_V4_2C_OMPL_PLANNER_GEOMETRY_PORTFOLIO.md) | drafted / blocked | OMPL planner-geometry portfolio (V4-230–V4-239). Artifact root: `results/v4_review/v4_2c_ompl_planner_portfolio/`. [Cursor guide](V4_2C_CURSOR_IMPLEMENTATION_GUIDE.md). Unauthorized until `ACTIVE_SPRINT.md` names that range. |
