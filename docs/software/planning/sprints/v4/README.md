...
**Status:** Sprint V4.1 is **completed**. Sprint V4.2 and V4.2A are **completed historical diagnostics**. Sprint V4.2B is **active at its final canonical-evidence and closeout gate**. Sprint V4.3 remains **drafted / blocked behind V4.2B**. Authorization is only the range named in `ACTIVE_SPRINT.md`.
...
A Version 3 span/wrench insert ([V3.6D–F program](../../V3_POST_V3_6C_SPAN_WRENCH_PROGRAM.md)) is completed after V3.6C/V4.0/V4.1. Sprint V4.2 consumed the V3.6D registry and is closed; Sprint V4.2A is a closed sibling visual-planning audit. Review found that their registry-consumption path retained native follower-angle offsets in the robot joint coordinate, along with bounded paired-graph, artifact, and provenance defects. The accepted [V4.2B amendment](../../V4_2B_CORRECTIVE_PROGRAM_AMENDMENT.md) inserts a fresh corrective closeout before drafted V4.3 may consume span snapshots. PR #27 landed an implementation checkpoint but intentionally left canonical evidence and V4-229 closeout open; the [final closeout gate](V4_2B_FINAL_CLOSEOUT_GATE.md) completes the same sprint rather than creating V4.2C. The local post-V4.0 span/wrench planning bundle is [superseded](../../../architecture/notes/V4_POST_V4_0_SPAN_STATIC_WRENCH_BUNDLE_SUPERSEDED.md); do not apply it.
...
| [V4.2B](SPRINT_V4_2B_SPAN_CONTROLLED_ATLAS_CORRECTIVE_CLOSEOUT.md) | active — final closeout gate | Mounted-coordinate corrective implementation is merged; final paired-edge admission, strict nonfinite semantics, manifest hardening, common-physical audit, canonical generation, independent review, and authorization reset remain (V4-220–V4-229). [Final gate](V4_2B_FINAL_CLOSEOUT_GATE.md). [Cursor guide](V4_2B_FINAL_CLOSEOUT_CURSOR_GUIDE.md). |
