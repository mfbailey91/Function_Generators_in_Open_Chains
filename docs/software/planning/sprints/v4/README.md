...
**Status:** Sprint V4.1 is **completed**. Sprint V4.2 and V4.2A are **completed historical diagnostics**. Sprint V4.2B is **completed**. Sprint V4.2C is **completed**. Sprint V4.2D is **active** (V4-240–V4-249). Sprint V4.3 remains **drafted / blocked**. Authorization is only the range named in `ACTIVE_SPRINT.md`.
...
| [V4.2D](SPRINT_V4_2D_OPTIMALITY_REFERENCE_AND_GEARBOX_CONTROL_REPORT.md) | active | Optimality-reference and gearbox-control report (V4-240–V4-249). Reconstructs the exact V4.2C center-IK direct optimum \(J^*_{C,m}\); historical V4.2B \(J^*_{B,m}\) is a representation-sensitivity control only. Writable root: `results/v4_review/v4_2d_optimality_reference_report/`. [ADR-032](../../../architecture/adr/ADR-032-planner-optimality-represented-goal-reference.md). V4.3 remains blocked. |
