...
**Status:** Sprint V4.1 is **completed**. Sprint V4.2 and V4.2A are **completed historical diagnostics**. Sprint V4.2B is **completed**. Sprint V4.2C is **completed**. Sprint V4.2D is **completed**. Sprint V4.3 remains **drafted / blocked**. Authorization is only the range named in `ACTIVE_SPRINT.md`.
...
A Version 3 span/wrench insert ([V3.6D–F program](../../V3_POST_V3_6C_SPAN_WRENCH_PROGRAM.md)) is completed after V3.6C/V4.0/V4.1. Sprint V4.2 consumed the V3.6D registry and is closed; Sprint V4.2A is a closed sibling visual-planning audit. Review found that their registry-consumption path retained native follower-angle offsets in the robot joint coordinate, along with bounded paired-graph, artifact, and provenance defects. The accepted [V4.2B amendment](../../V4_2B_CORRECTIVE_PROGRAM_AMENDMENT.md) inserted a fresh corrective closeout before drafted V4.3 may consume span snapshots. Canonical V4.2B evidence is retained; the [final closeout gate](V4_2B_FINAL_CLOSEOUT_GATE.md) is closed. Sprint V4.2C is a completed sibling Column A planning diagnostic; Sprint V4.2D is a completed sibling optimality-reference report derived from frozen V4.2B/V4.2C packages; V4.3 remains blocked. The local post-V4.0 span/wrench planning bundle is [superseded](../../../architecture/notes/V4_POST_V4_0_SPAN_STATIC_WRENCH_BUNDLE_SUPERSEDED.md); do not apply it.
...
| [V4.2C](SPRINT_V4_2C_OMPL_PLANNER_GEOMETRY_PORTFOLIO.md) | completed | OMPL planner-geometry portfolio. Canonical package: `results/v4_review/v4_2c_ompl_planner_portfolio/`. Derived V4.2C-R presentation: `results/v4_review/v4_2c_r_frozen_data_report/`. [Closeout](../../../architecture/notes/V4_2C_OMPL_PLANNER_PORTFOLIO_CLOSEOUT.md). [Review](../../../architecture/notes/V4_2C_IMPLEMENTATION_REVIEW.md). [Plot guide](../../../architecture/notes/V4_2C_CLOSEOUT_REVIEW_AND_PLOT_GUIDE.md). V4.3 remains blocked. |
| [V4.2D](SPRINT_V4_2D_OPTIMALITY_REFERENCE_AND_GEARBOX_CONTROL_REPORT.md) | completed | Optimality-reference and gearbox-control report (V4-240–V4-249). Canonical package: `results/v4_review/v4_2d_optimality_reference_report/`. Reconstructs the exact V4.2C center-IK direct optimum \(J^*_{C,m}\); historical V4.2B \(J^*_{B,m}\) is a representation-sensitivity control only. [Closeout](../../../architecture/notes/V4_2D_OPTIMALITY_REFERENCE_CLOSEOUT.md). [Review](../../../architecture/notes/V4_2D_IMPLEMENTATION_REVIEW.md). [ADR-032](../../../architecture/adr/ADR-032-planner-optimality-represented-goal-reference.md). V4.3 remains blocked. |
