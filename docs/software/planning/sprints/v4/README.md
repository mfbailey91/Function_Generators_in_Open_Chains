...
**Status:** Sprint V4.1 is **completed**. Sprint V4.2 and V4.2A are **completed historical diagnostics**. Sprint V4.2B is **completed**. Sprint V4.2C is **completed**. Sprint V4.3 remains **drafted / blocked**. Authorization is only the range named in `ACTIVE_SPRINT.md`.
