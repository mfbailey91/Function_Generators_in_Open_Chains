...
Deliver `docs/software/architecture/audits/V2_1_SEARCH_COUPLING_AUDIT.md` with before/after status.
...
tests/golden_v1/...
docs/software/architecture/audits/V2_1_SEARCH_COUPLING_AUDIT.md
```
