...
7. [Sprint V3.6 — Free-Space Planner Evidence](SPRINT_V3_6_FREE_SPACE_EVIDENCE.md) (**active**)
        ...
        └── V3.1 core problem/result interfaces
              └── V3.2 direct 2R vertical slice
                    └── V3.3 lattice/local-motion validation
                          ...
                          │           └── V3.6 free-space evidence (active)
