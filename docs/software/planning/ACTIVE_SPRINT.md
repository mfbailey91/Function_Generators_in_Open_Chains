...
**Current focus:** Sprint V4.2B — Span-Controlled Atlas Corrective Closeout.
...
**Roadmap:** V4.2B corrective gate → separate V4.3 intrinsic-wrench activation → V4.4 velocity/IK. Residual V3.7 remains separately drafted / blocked. See [V4.2B amendment](V4_2B_CORRECTIVE_PROGRAM_AMENDMENT.md), [V4 sprint index](sprints/v4/README.md), [ADR-027](../architecture/adr/ADR-027-v4-kinematic-transmission-geometry.md), [ADR-028](../architecture/adr/ADR-028-gravity-free-static-wrench.md), and [ADR-029](../architecture/adr/ADR-029-mounted-output-coordinate.md).
