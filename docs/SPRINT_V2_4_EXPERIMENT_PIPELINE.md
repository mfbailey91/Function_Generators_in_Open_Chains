...
Create a dedicated row model. Record all fields listed in `PROJECT_PLAN.md`, including branch certificate, sampling domain, transition parameterization, endpoint residuals, spacing summaries, and code revision.
