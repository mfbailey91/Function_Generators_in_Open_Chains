...
- `docs/ADR-001-search-in-input-space.md`
- `docs/ADR-011-output-space-semantics.md`
- `docs/SPRINT_FOUR_BACKLOG.md`
...
Create `docs/notes/V1_BASELINE_FREEZE.md` containing:
...
Create `docs/ADR-014-v2-output-state-on-invertible-branches.md`.
...
Create `docs/ADR-015-topology-embedding-transition-provenance.md`.
...
Create `docs/ADR-016-v1-v2-configuration-compatibility.md`.
...
```text
docs/ADR-014-v2-output-state-on-invertible-branches.md
docs/ADR-015-topology-embedding-transition-provenance.md
docs/ADR-016-v1-v2-configuration-compatibility.md
docs/notes/V1_BASELINE_FREEZE.md
.cursor/rules/project.mdc
tests/golden_v1/...
```
...
```text
Implement Sprint V2.0 only. Read docs/PROJECT_PLAN.md, ADR-001, ADR-011,
